...
{
 Helper::options()->commentsMaxNestingLevels = 5050;//正常设置最高只有7层
...
* @return void
*/
function theNext($widget, $randompicUrl): void
{
  $db = Typecho_Db::get();
...
function thePrev($widget, $randompicUrl)
{
  ...
  $link = '<a title="没有啦" class="carousel"><div style="background-image:url('.$randompicUrl.');" class="card-img tu"></div><div class="carousel-indicators"><h3 class="heading-title text-info blackback" style="text-transform:none;">没啦</h3></div></a>';
  echo $link;
  }
}
...
// 在下面按格式输入本站创建的时间
$site_create_time = strtotime('2022-11-14 23:20:00');
